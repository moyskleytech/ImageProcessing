...
{
    public class WPFImageLoader
    {
        public BitmapImage LoadAsWPF(string filename)
        {
            BitmapImage bitmapSource = new BitmapImage();
            bitmapSource.BeginInit();
            bitmapSource.BaseUri = new Uri(filename);
            bitmapSource.CacheOption = BitmapCacheOption.OnLoad;
            bitmapSource.EndInit();
            return bitmapSource;
        }
        public Image<Pixel> LoadAsLib(string filename)
        {
            var wpfs = LoadAsWPF(filename);
            var bit = wpfs.ToBitmap();
            return bit;
        }
    }
    ///<source>http://james-ramsden.com/get-file-types-supported-by-bitmapimage/</source>
    /// <summary>
