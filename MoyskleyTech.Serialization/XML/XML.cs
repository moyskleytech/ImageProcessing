...
namespace MoyskleyTech.Serialization.XML
{
    ...
    public class XMLUtility
    {
        ...
        {
           return Serialize(o ,  new Dictionary<object , int>());
        }
        public static string Serialize(object o , Dictionary<object , int> context)
        {
            StringBuilder sb = new StringBuilder();

           
            SerializeInternal(o , sb , context);

            return sb.ToString();
        }
        private static void SerializeInternal(object o , StringBuilder bw , Dictionary<object , int> set , Type innerType = null)
        {
