...
namespace MoyskleyTech.ImageProcessing.Image
{
    ...
    public partial class Graphics<Representation> : IDisposable where Representation : unmanaged
    {
        ...
        /// <param name="y2">Y destination</param>
        /// <param name="thickness">Thickness of line</param>
        private void DrawLineBeforeTransform(Representation p, double x1, double y1, double x2, double y2, double thickness)
        {
            thickness /= 2;
        ...
        /// <param name="y2">Y destination</param>
        /// <param name="thickness">Thickness of line</param>
        private void DrawLineBeforeTransform(Brush<Representation> p, double x1, double y1, double x2, double y2, double thickness)
        {
            thickness /= 2;
            // < line x1 = "0" y1 = "0" x2 = "200" y2 = "200" style = "stroke:rgb(255,0,0);stroke-width:2" />
